...
\usepackage{bookmark}
%But forget about citations, cause it's a CF
\let\oldcitet\citet
\let\oldcitep\citep
\renewcommand{\citet}[2][]{\begin{NoHyper}\oldcitet[#1]{#2}\end{NoHyper}}
\renewcommand{\citep}[2][]{\begin{NoHyper}\oldcitep[#1]{#2}\end{NoHyper}}
