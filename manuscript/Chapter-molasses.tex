...
The set of cellular automata is defined as
	...
	\subsection[Cells in E$2$]{Cells in E$^2$}
		%DEM_LOADER
		%INITFLOW
		%ACTIVATE
	...
	\subsection[Source Locations, V, and the Source Function, $\gamma$]{Source Locations, V, and the Source Function, $\gamma$}
		%INITFLOW
		%PULSE
	...
	\subsection[Substates, S, and the Transition Function, $\sigma$]{Substates, S, and the Transition Function, $\sigma$}
		%INITFLOW
		%DISTRIBUTE
