...
\begin{figure}
\centering
\includegraphics[width=0.5\linewidth]{\FigPath/locators/mars_locator_300dpi.png}
...
\begin{figure}
\centering
\includegraphics[width=0.6\linewidth]{\FigPath/locators/venus_globe_300dpi.png}
...
\begin{figure}[h!]
    ...
    \begin{subfigure}{0.49\textwidth}
        \centering
        \includegraphics[width=\linewidth]{\FigPath/egrikuyu_kde_300dpi}
    \end{subfigure}
    \begin{subfigure}{0.49\textwidth}
        \centering
        \includegraphics[width=\linewidth]{\FigPath/egrikuyu_vol_300dpi}
    \end{subfigure}
...
\begin{figure}[h!]
    ...
    \begin{subfigure}{0.49\textwidth}
        \centering
        \includegraphics[height=8cm]{\FigPath/arsia_kde_300dpi}
    \end{subfigure} 
    \begin{subfigure}{0.49\textwidth}
        \centering
        \includegraphics[height=8cm]{\FigPath/arsia_vol_300dpi}
    \end{subfigure}
...
\begin{subfigure}{0.49\textwidth}
\centering
\includegraphics[width=\linewidth]{\FigPath/adams_kde_300dpi}
\end{subfigure}
\begin{subfigure}{0.49\textwidth}
\centering
\includegraphics[width=\linewidth]{\FigPath/newberry_kde_300dpi}
\end{subfigure}
...
\begin{subfigure}{0.49\textwidth}
\centering
\includegraphics[width=\linewidth]{\FigPath/sanfrancisco_kde_300dpi.png}
\end{subfigure}
\begin{subfigure}{0.49\textwidth}
\centering
\includegraphics[width=\linewidth]{\FigPath/sanfranciscoP_kde_300dpi.png}
\end{subfigure}
\begin{subfigure}{0.49\textwidth}
\centering
\includegraphics[width=\linewidth]{\FigPath/sanfranciscoM_kde_300dpi.png}
\end{subfigure}
\begin{subfigure}{0.49\textwidth}
\centering
\includegraphics[width=\linewidth]{\FigPath/sanfranciscoB_kde_300dpi.png}
\end{subfigure}
...
\begin{figure}
\centering
\includegraphics[width=0.6\linewidth]{\FigPath/springerville_kde_300dpi}
...
\begin{figure}
\centering
\includegraphics[width=0.6\linewidth]{\FigPath/syria_kde_300dpi}
...
\begin{figure}
\centering
\includegraphics[width=0.6\linewidth]{\FigPath/sanrafael_kde_300dpi}
...
\begin{figure}
\centering
\includegraphics[width=0.6\linewidth]{\FigPath/arsia_kde_300dpi}
