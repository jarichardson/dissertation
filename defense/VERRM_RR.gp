...
set ylabel "Recurrence rate (events/Myr)"
# Axes ranges
set xrange [350:0]
# Axes tics
set y2tics 0.25
...
plot "../manuscript/data/Arsia_Mons_Koji_Style_MA_RR_4_crater_neighbor.dat" u 1:4:2 w filledcurve lt rgb "black" notitle,\
...
set output "figures/defense/VERRM_RR.eps"
replot
