...
\section{}
	...
	\begin{tikzpicture}
		\node (img1) [rotate=-90] {\includegraphics[width=0.2\textwidth]{figures/defense/vanity/20150224_101348.jpg}};		
		\node (img2) {\includegraphics[width=0.2\textwidth]{figures/defense/vanity/IMG_4091.JPG}};
		\node (img3) {\includegraphics[width=0.2\textwidth]{figures/defense/vanity/IMG_4431.JPG}};
		\node (img4) {\includegraphics[width=0.2\textwidth]{figures/defense/vanity/matt_pasek_500.jpg}};
		\node (img5) {\includegraphics[width=0.2\textwidth]{figures/defense/vanity/vCrewMissionTraining.jpg}};
	\end{tikzpicture}
	}

	\frame{\frametitle{Questions?}
	\includegraphics[width=0.8\textwidth]{figures/defense/vanity/IMG_3981.JPG}
	}
\fi
