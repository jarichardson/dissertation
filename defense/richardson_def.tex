...
\subsection{Results}
	...
	\begin{block}{Discharge rate through time}
	\begin{columns}
	\column{0.5\textwidth}
	%\centering
...
\subsection{Implications}
	\frame{\frametitle{Tie in with Ashes and glaciers?}
		\includegraphics[width=0.3\textwidth]{figures/defense/arsia_overview.jpg}
		\includegraphics[width=0.2\textwidth]{figures/defense/shean_graben.png}
		\mbox{\tiny \textit{from Shean et al., JGR Planets, 2007}}
	}

	\frame{\frametitle{Model of waning volcanism of Arsia}
	Volcanism transitioned from explosive to effusive
	
	Corresponds to a waning of recurrence rate of volcanism
