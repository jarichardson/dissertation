...
\begin{abstract}
\thispagestyle{plain}
Sills are important, but so is lava. There are volcanoes on Mars around Arsia Mons and Syria Planum. Volcano clusters can be compared with non-parametric statistics even if they are on different planets.
...
\include{bookends/introduction}
\include{Chapter-sills/Chapter-sills}
\include{Chapter-molasses/Chapter-molasses}
\include{Chapter-arsia/Chapter-arsia}
\include{Chapter-syria_planum/Chapter-syria_planum}
\include{Chapter-spatial_density/Chapter-spatial_density}
\include{bookends/conclusions}
\include{bookends/appendices}
