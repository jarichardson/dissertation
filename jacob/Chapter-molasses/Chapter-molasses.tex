...
\title{Validating Lava Flow Simulators using a Validation Hierarchy and Bayesian Analysis}
%\date{}
...
\begin{figure}[!h]
	\centering
	\includegraphics[width=0.7\linewidth]{figures/locator_complete_300dpi}
	\caption{The Tolbachik region of Kamchackta, Russia. The two main vents are shown as triangles and the outline of western lava flows, emplaced in 2014, is drawn in red.}
	\label{fig_locator}
\end{figure}
